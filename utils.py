...
def parse_command():
    ...
    parser.add_argument('-b', '--batch-size', default=24, type=int, help='mini-batch size (default: 4)')
    ...
    parser.add_argument('--betas', default=(0.9, 0.999), type=tuple, metavar='M',
                        help='beta1 and beta2')
